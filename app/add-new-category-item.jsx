            ...
            <ScrollView>
                <View style={styles.container}>
                    ...
                    <View style={styles.flex}>
                        ...
                        <TextInput value={name} onChangeText={(name) => setName(name)} placeholder="Name"
                                   style={styles.textInput}/>
                    </View>

                    <View style={styles.flex}>
                        <FontAwesome6 name="dollar-sign" size={24} color={Colors.black}/>
                        <TextInput value={cost} onChangeText={(cost) => setCost(cost)} placeholder="Cost"
                                   keyboardType="numeric" style={styles.textInput}/>
                    </View>

                    <View style={styles.flex}>
                        <FontAwesome6 name="link" size={24} color={Colors.black}/>
                        <TextInput value={url} onChangeText={(url) => setUrl(url)} placeholder="Url"
                                   style={styles.textInput}/>
                    </View>

                    <View style={styles.flex}>
                        <FontAwesome6 name="pencil" size={24} color={Colors.black}/>
                        <TextInput value={desc} onChangeText={(desc) => setDesc(desc)} placeholder="Note"
                                   style={styles.textInput} numberOfLines={4}/>
                    </View>


                </View>
                <TouchableOpacity disabled={!name || !cost || loading} onPress={handlePress}
                                  style={{
                                      ...styles.button,
