    ...
    return (
        ...
        >
            ...
            <View style={styles.cardContainer}>
                        ...
                        <View style={{flex: 1}}>
                            {categories?.map(c => (
                                <View style={styles.legendTitle} key={c.id}>
                                    <MaterialCommunityIcons name="checkbox-blank-circle" size={24} color={c.color}/>
                                    <Text>{c.name}</Text>
                                </View>
                            ))}
                        </View>
                ...
                <Link href={{pathname: "/add-new-category", params: {email: user?.email}}} style={styles.addButton}>
