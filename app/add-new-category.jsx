...
/**
 * Function representing the creation of a new category with user input data.
 * Handles setting category name, budget, color, and icon selection.
 * Shows a modal for selecting an emoji icon and a color picker for choosing a category color.
 * Validates user input and creates a new category in the database upon button press.
 */
  ...
  const handlePress = async () => {
    ...
    try {
      ...
      router.replace({
        ...
        params: { categoryId: newCatRef.id },
      });
    } catch (err) {
      Toast.show({
        type: "error",
  ...
  return (
    <ScrollView>
      ...
      <View style={styles.flex}>
        ...
        <TextInput
          onChangeText={(budget) => setTotalBudget(budget)}
      ...
      <TouchableOpacity
        ...
        style={{
          ...styles.sendButton,
          backgroundColor:
            !categoryName || !totalBudget ? Colors.disabled : selectedColor,
        }}
      >
        {loading ? (
